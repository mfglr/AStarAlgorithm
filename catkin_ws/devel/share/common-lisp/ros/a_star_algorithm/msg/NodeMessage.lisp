...
(cl:defmethod g-val ((m <NodeMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a_star_algorithm-msg:g-val is deprecated.  Use a_star_algorithm-msg:g instead.")
  (g m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<NodeMessage>)))
  ...
  "055d2c8f3fa27ed8eee4293f534be47c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'NodeMessage)))
  "Returns md5sum for a message object of type 'NodeMessage"
  "055d2c8f3fa27ed8eee4293f534be47c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<NodeMessage>)))
  ...
  (cl:format cl:nil "VectorMessage location~%int32 g~%================================================================================~%MSG: a_star_algorithm/VectorMessage~%int32 x~%int32 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'NodeMessage)))
  "Returns full string definition for message of type 'NodeMessage"
  (cl:format cl:nil "VectorMessage location~%int32 g~%================================================================================~%MSG: a_star_algorithm/VectorMessage~%int32 x~%int32 y~%~%"))
